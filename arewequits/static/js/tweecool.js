        ...
        tweecool: function (options) {
            ...
            function xTimeAgo(time) {
                ...
                //var gmtDate = Date.UTC(nd.getFullYear(), nd.getMonth(), nd.getDate(), nd.getHours(), nd.getMinutes(), nd.getMilliseconds());
                    gmtDate = Date.parse(nd),
                    tweetedTime = time * 1000, //convert seconds to milliseconds
                    timeDiff = (gmtDate - tweetedTime) / 1000, //convert milliseconds to seconds
                ...
                if (timeDiff >= month && timeDiff < year) {
